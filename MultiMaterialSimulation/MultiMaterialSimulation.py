...
class MultiMaterialSimulationParameterNode:
    ...
    LVADTransformNode: vtkMRMLTransformNode
...
class MultiMaterialSimulationWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self) -> None:
        ...
        self.ui.addLVADTransformPushButton.connect("clicked()", self.logic.addLVADTransform)
...
class MultiMaterialSimulationLogic(SlicerSofaLogic):
    ...
    def addLVADTransform(self) -> None:
        transformNode = slicer.mrmlScene.AddNewNodeByClass("vtkMRMLTransformNode", "LVAD Transform")
        transformNode.CreateDefaultDisplayNodes()
        self.getParameterNode().LVADTransformNode = transformNode
